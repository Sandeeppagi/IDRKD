...
def tool_selection_prompt(*, prompt: str, tools: list[dict[str, Any]]) -> str:
    return (
        ...
        "Choose exactly one tool from its description and input schema. Copy only user-provided "
        "scope values into the required arguments and do not invent defaults.\n\n"
